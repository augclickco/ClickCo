...
Submitted from CLiCKCO website
    ...
    try {
      const mailtoLink = `mailto:clickco@zohomail.in?subject=${encodeURIComponent(
    ...
    <div className="px-6 py-16 md:py-24">
      <div className="mx-auto max-w-2xl">
        ...
        {status === "sent" ? (
          <div className="mt-12 rounded-2xl border border-border bg-card p-10 text-center">
            ...
            <p className="mt-3 text-muted">
              ...
              <a href="mailto:clickco@zohomail.in" className="underline">
                clickco@zohomail.in
              </a>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="mt-12 space-y-6">
            ...
            {status === "error" && (
              <p className="text-sm text-red-500">
                Something went wrong. Please email us directly at clickco@zohomail.in
              </p>
            )}
          </form>
        )}
        ...
        <div className="mt-16 border-t border-border pt-10 text-sm text-muted">
          ...
          <p>
            Email:{" "}
            <a href="mailto:clickco@zohomail.in" className="underline hover:text-foreground">
              clickco@zohomail.in
            </a>
          </p>
        </div>
